...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <div className="relative isolate p-4 px-8 ">
        <section className="mx-auto flex w-full py-4 rounded-xl bg-primary-50">
          <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-5">
              <h1 className="tracking-tight text-primary-900 drop-shadow-md stroke-1 font-black text-h1 shadow-grey-900">Get access to</h1>
              <h3 className='text-h4 font-bold my-7'>AI-Driven Personalised <br /> suggestions on <br /> mutual fund schemes</h3>
      ...
      <div className="relative">
        <h4 className="text-center text-h5 font-bold">Let’s ease up the decision making process for your investments</h4>
        <h3 className="text-center text-h3 font-bold mt-44">Find the scheme that fits your <br /> needs perfectly</h3>
        <img src="./images/bg.png" className="absolute top-10 left-2/4 w-2/4 -z-10" style={{ transform: 'translatex(-50%)' }} alt="" />
        <div className="grid md:grid-cols-12 max-w-screen-xl px-4 py-8 mx-auto mt-7">
          <div className="md:col-span-6">
            <ul className="">
              <li className="text-h6 font-medium mb-4 ">Confused about where to Invest? Too many options  to choose from?</li>
              <li className="text-h6 font-medium mb-4 ">Don’t worry!</li>
              <li className="text-h6 font-medium mb-4 ">We will pick out personalised mutual fund schemes based on your needs that align with your wealth goals.</li>
            </ul>
          </div>
          <div className="md:col-span-6">
      ...
      <div className="relative md:mt-36 p-4 px-8 ">
        ...
        <div className="mx-auto w-full py-2 rounded-xl bg-primary-50">
          <h3 className="text-center text-h3 w-full font-bold mt-4 mx-auto">An informative & easy-to <br /> understand Dashboard</h3>
          <div className="grid md:grid-cols-12 max-w-screen-xl px-4 pt-8 pb-4 mx-auto mt-7">
            ...
            <div className="md:col-span-6 md:ms-11 md:me-16 mt-10">
              ...
              <div className="bg-sky-500 rounded-lg gap-2.5 w-full bg-primary-500 border-s-4 border-s-primary-900 my-5">
                <NavLink to={'/signup'} className="text-white-100 px-5 py-6 text-h6 font-bold  rounded-md justify-start items-start gap-2 flex">
      ...
      <div className="relative my-24 mx-8 bg-[url('./images/bg2.png')] bg-left bg-cover">
        <div className="grid md:grid-cols-12 max-w-screen-xl px-4 pt-8 pb-4 mx-auto mt-7">
          <div className="md:col-span-6 md:ms-11 md:me-16 my-auto">
            <h3 className="text-h3 font-bold mb-10">With 128-bit encryption <br />
      ...
      <div className="relative my-24 mx-8">
        <h2 className="text-center text-h2 w-full font-bold mt-4 mb-8 mx-auto">How finorator works</h2>
        {steps.map((curElem) =>
          <div className="grid md:grid-cols-12 max-w-screen-xl px-4 pt-4 mx-auto" key={curElem.id}>
            <div className="md:col-span-6 md:ms-11 md:me-16 my-auto">
              <span className="text-h5 font-bold">Step {curElem.id}</span>
              <h3 className="text-h3 font-bold my-3">{curElem.heading}</h3>
              <p className=" text-regular">{curElem.pera}</p>
            </div>
            <div className="md:col-span-6">
      ...
      <div className="relative mt-32 mb-20 mx-8">
        <h2 className="text-center text-h2 w-full font-bold mt-4 mb-8 mx-auto">Why choose finorator</h2>
        <div className="grid md:grid-cols-12 gap-5 md:px-4 pt-4 mx-auto">
          {choose.map((curElem) =>
            <div className="md:col-span-3 bg-white-50 py-8 px-5 my-auto shadow-xl text-center rounded-xl" key={curElem.id}>
              <img src={curElem.iconURL} className=" w-[100px] mx-auto" alt="" />
              <div className=" text-h5 font-bold my-5 px-14">{curElem.heading}</div>
              <p className=" text-regular">{curElem.pera}</p>
            </div>
          )}
        </div>
      ...
      <div className="relative md:mx-8 pb-8 md:pb-56">
        <div className="grid md:grid-cols-12 gap-5 md:p-10 p-4 rounded-xl mx-auto bg-secondary-50">
          <div className="md:col-span-7 rounded-xl">
          ...
          <div className="md:col-span-5 md:py-8 md:px-5 my-auto gap-5 rounded-xl md:flex">
            <div className="bg-sky-500 rounded-lg gap-2.5 w-full bg-primary-500 mb-5 md:md-0">
            ...
            <div className="bg-sky-500 rounded-lg gap-2.5 w-full bg-white-50 border-2 border-primary-500">
      ...
      <div className="relative md:mx-8">
        <div className="grid md:grid-cols-12 gap-5 md:p-10 p-4 rounded-xl mx-auto bg-primary-50">
          ...
          <div className="md:col-span-3 bg-white-50 my-auto shadow-xl rounded-xl">
