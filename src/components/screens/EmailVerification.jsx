            ...
            <div className="w-full md:w-2/3 flex flex-col items-center  p-10 gap-10">
                <div className='p-8 flex flex-col justify-center items-center gap-12 border-white-600 border-[1px]'>
                    ...
                    <div className='h-[115px] w-[115px] '>
                        {!success ?
                            <img className={`bg-cover rounded-[50%] bg-[#D9ECF7] ${loading ? 'animate-spin' : ''}`} src='./images/Emailspinner.png' /> :
...
export const EmailVerificationLoadingScreen = (loading) => {
    if (loading) {
        return (
            <>
                <div className='w-full flex justify-between '>
                    <div className="w-full md:w-2/3 flex flex-col items-center  p-10 gap-10">
                        <div className='p-8 w[365px] h-[565px] flex flex-col justify-center items-center gap-12 border-white-600 border-[1px]'>
                            <p className='text-center font-medium font-sans text-h4'>Email Verification</p>
                            <div className='flex flex-col gap-8'>
                                <div className=' h-[25px] w-[220px] bg-white-600 rounded-xl mx-auto animate-pulse'>
                                </div>
                                <div className=' h-[25px] w-[220px] bg-white-600 rounded-xl mx-auto animate-pulse'>
                                </div>
                                <div className=' h-[25px] w-[220px] bg-white-600 rounded-xl mx-auto animate-pulse'>
